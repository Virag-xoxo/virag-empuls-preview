...
const FEATURED = {
  ...
  metric: "82",
  metricSuffix: "%",
  metricLabel: "benefits enrollment",
  metricContext: "of eligible employees actively enrolled in at least one Empuls benefit category within 90 days",
  quote: "Our old benefits stack was four vendors and three logins. Moving to Empuls cut that to one — and enrolment hit 80%+ in the first quarter. Employees actually use what they're given now.",
  name: "Catherine Reed",
...
const COMPACT = [
  {
    ...
    metric: "3.4",
    metricSuffix: "×",
    metricLabel: "monthly utilization",
    metricContext: "increase in monthly benefits utilization vs the legacy reimbursement-only program",
    quote: "When the same wallet covers gym, learning, and meals, people use it. Friction was the problem — not the budget. Now we get receipts on the same day, not at year-end.",
    name: "Daniel Foster",
  ...
  },
  {
    ...
    metric: "40",
    metricSuffix: "%",
    metricLabel: "drop in HR queries",
    metricContext: "fewer benefits-related tickets after rolling out the self-serve portal company-wide",
    quote: "HR used to spend two days a week answering 'how do I claim X' questions. The portal answers those itself. Our team now spends that time on programs, not paperwork.",
    name: "Megan Hayes",
...
const STATS = [
  { value: "82%",  label: "Benefits enrollment" },
  { value: "3.4×", label: "Monthly utilization" },
  { value: "40%",  label: "HR queries reduced" },
    ...
    <section className="relative bg-dark-300 py-20 lg:py-28 overflow-hidden">
      ...
      <div className="max-w-[1280px] mx-auto px-6">
        <div className="text-center max-w-xl mx-auto mb-14">
          ...
          <h2 className="text-3xl lg:text-4xl font-bold text-white tracking-tight mb-4">People teams that retired four vendors for one</h2>
          <p className="text-dark-000 text-base leading-relaxed">Companies that swapped fragmented benefits stacks for a single platform — and watched enrollment, utilization, and rep satisfaction lift together.</p>
        </div>

    ...
    <section className="py-20 lg:py-28 bg-white overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-6">
        <motion.div className="text-center max-w-xl mx-auto mb-14"
          ...
          <p className="text-[11px] font-bold uppercase tracking-[0.15em] text-blue-200 mb-3">Plugs into payroll</p>
          <h2 className="text-3xl lg:text-4xl font-bold text-dark-300 tracking-tight mb-4">HRIS-driven enrollment, payroll-synced loads</h2>
          <p className="text-dark-100 text-base leading-relaxed">
            Native sync with Darwinbox, BambooHR, SAP SuccessFactors, Workday, Keka, and Zoho People. Card loads run as part of the payroll cycle, MCC reports drop directly into the finance dashboard, and statutory exports are generated automatically.
          </p>
        </motion.div>

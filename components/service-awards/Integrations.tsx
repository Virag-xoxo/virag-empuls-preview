      ...
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-3xl lg:text-4xl font-bold text-dark-300 tracking-tight mb-4">
            Service awards in the tools your teams already use
          </h2>
          <p className="text-dark-100 text-base leading-relaxed">
            HRMS-connected for joining-date sync. Slack, Teams, Gmail and Outlook for the celebration moment. 50+ integrations, zero migration.
          </p>
        </motion.div>

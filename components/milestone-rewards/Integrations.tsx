    ...
    <section className="py-20 lg:py-28 bg-white overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-6">
        <motion.div className="text-center max-w-xl mx-auto mb-14"
          ...
          <p className="text-[11px] font-bold uppercase tracking-[0.15em] text-blue-200 mb-3">Triggers from any system</p>
          <h2 className="text-3xl lg:text-4xl font-bold text-dark-300 tracking-tight mb-4">Connected to your HRMS, LMS, project tools, and wearables</h2>
          <p className="text-dark-100 text-base leading-relaxed">Plus Slack, Teams, Gmail and Outlook for delivery. 250+ integrations, plus REST API for custom triggers.</p>
        </motion.div>

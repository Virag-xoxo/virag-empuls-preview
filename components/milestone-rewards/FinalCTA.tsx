...
export default function FinalCTA() {
  ...
  return (
    <section className="relative bg-dark-300 overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 w-[480px] h-[480px] pointer-events-none" style={{ background: "radial-gradient(ellipse at 80% 80%, rgba(29,97,246,0.18) 0%, rgba(237,123,48,0.08) 40%, transparent 70%)" }} />
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-10 lg:gap-16">
          <motion.div className="max-w-xl"
            ...
            <h2 className="text-4xl lg:text-5xl font-bold tracking-tight leading-tight mb-6">
              <span className="text-white">Stop letting achievements<br/></span>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-100 to-blue-200">go unrewarded</span>
            </h2>
            <p className="text-dark-000 text-base leading-relaxed">
              See how Empuls automates milestone rewards across your entire workforce — in a 20-minute walkthrough.
            </p>
          </motion.div>

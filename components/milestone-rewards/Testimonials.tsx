...
const FEATURED = {
  ...
  metric: "22",
  metricSuffix: "%",
  metricLabel: "productivity lift",
  metricContext: "across teams running structured milestone programs",
  quote: "We had a dozen disconnected reward programs across HR, L&D, and ops. Empuls consolidated all of it into one trigger engine — and our HR team got 40 hours a month back.",
  name: "Catherine Reed",
...
const COMPACT = [
  {
    ...
    metric: "89",
    metricSuffix: "%",
    metricLabel: "engagement reported",
    metricContext: "in teams with real-time achievement recognition",
    quote: "The leaderboards changed sales completely. Reps stopped chasing month-end and started chasing daily milestones — pipeline coverage doubled.",
    name: "Daniel Foster",
  ...
  },
  {
    ...
    metricContext: "vs. teams without consistent achievement rewards",
    quote: "Multi-stage referral rewards alone paid for the platform. We hire faster, and our employees feel rewarded for quality, not just quantity.",
    name: "Megan Hayes",
...
const STATS = [
  { value: "1M+",  label: "Reward catalog options" },
  { value: "175+", label: "Countries supported" },
  { value: "250+", label: "HRMS / LMS integrations" },
  { value: "0",    label: "Manual reward steps" },
];
    ...
    <section className="relative bg-dark-300 py-20 lg:py-28 overflow-hidden">
      ...
      <div className="max-w-[1280px] mx-auto px-6">
        <div className="text-center max-w-xl mx-auto mb-14">
          ...
          <h2 className="text-3xl lg:text-4xl font-bold text-white tracking-tight mb-4">Trusted by teams that automate recognition at scale</h2>
          <p className="text-dark-000 text-base leading-relaxed">Companies that turned scattered reward programs into one always-on trigger engine.</p>
        </div>

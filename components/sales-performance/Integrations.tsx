    ...
    <section className="py-20 lg:py-28 bg-white overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-6">
        <motion.div className="text-center max-w-xl mx-auto mb-14"
          ...
          <p className="text-[11px] font-bold uppercase tracking-[0.15em] text-blue-200 mb-3">Feeds from your revenue stack</p>
          <h2 className="text-3xl lg:text-4xl font-bold text-dark-300 tracking-tight mb-4">Plugs into the CRM, HRIS, and channels your team already uses</h2>
          <p className="text-dark-100 text-base leading-relaxed">
            Native CRM connectors for Salesforce, HubSpot, Zoho CRM, and Microsoft Dynamics. HRIS sync for the rep roster and territory assignments. AI nudges and contest standings land in Slack, Teams, and email automatically.
          </p>
        </motion.div>

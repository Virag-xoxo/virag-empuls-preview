...
const FEATURED = {
  ...
  quote: "Our managers used to spend Tuesday mornings rebuilding the leaderboard. Now they spend Tuesday mornings coaching the deals at risk — the data is already in front of them.",
  name: "Daniel Foster",

...
const ROW_1 = [CHANNELS[0], HRIS[0], CHANNELS[1], HRIS[1], HRIS[2], CHANNELS[2], HRIS[3]];
    ...
    <section className="py-20 lg:py-28 bg-white overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-6">
        <motion.div className="text-center max-w-xl mx-auto mb-14"
          ...
          <h2 className="text-3xl lg:text-4xl font-bold text-dark-300 tracking-tight mb-4">Onboarding in the tools your teams already use</h2>
          <p className="text-dark-100 text-base leading-relaxed">HRMS-connected for joining-date sync. Slack, Teams, email for the welcome moment. 250+ integrations, zero migration.</p>
        </motion.div>

        <motion.div initial={reduce ? undefined : { opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.6, ease, delay: 0.1 }}
          ...
          <div aria-hidden className="absolute inset-0 -z-10 opacity-40 rounded-3xl" style={{ backgroundImage: "radial-gradient(circle, #BFC9DA 1px, transparent 1px)", backgroundSize: "28px 28px" }} />

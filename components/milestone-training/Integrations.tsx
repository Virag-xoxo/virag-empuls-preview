  ...
  return (
    <div className="overflow-hidden w-full">
      <div className="flex gap-3 w-max"
        style={{ animation: `${reverse ? "slideRight" : "slideLeft"} ${speed}s linear infinite`, willChange: "transform" }}>
    ...
    <section className="py-20 lg:py-28 bg-white overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-6">
        <motion.div className="text-center max-w-xl mx-auto mb-14"
          ...
          <p className="text-[11px] font-bold uppercase tracking-[0.15em] text-blue-200 mb-3">Works where your teams already work</p>
          <h2 className="text-3xl lg:text-4xl font-bold text-dark-300 tracking-tight mb-4">Connects to your LMS, celebrates in your team channels</h2>
          <p className="text-dark-100 text-base leading-relaxed">
            Native webhooks for Coursera, Udemy Business, LinkedIn Learning, Cornerstone, SAP SuccessFactors, and Degreed. HRIS keeps the learner roster current. Cert wins land in Slack, Teams, and email automatically.
          </p>
        </motion.div>
        ...
        <motion.div className="flex flex-wrap items-center justify-center gap-6 mt-10"
          initial={reduce ? undefined : { opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.25 }}>
          ...
          <div className="flex flex-col items-center gap-2">
            <p className="text-[10px] font-bold uppercase tracking-[0.14em] text-dark-100">HRIS &amp; LMS</p>

...
const FEATURED = {
  ...
  metric: "2",
  metricSuffix: "×",
  metricLabel: "course completion rate",
  metricContext: "across our cloud and security skill paths",
  quote: "Tying rewards to certs changed everything. Engineers don&apos;t just enroll — they finish. Our cloud certifications doubled in two quarters.",
  name: "Catherine Reed",
  title: "Head of L&D",
...
const COMPACT = [
  {
    ...
    metric: "94",
    metricSuffix: "%",
    metricLabel: "pursue further learning",
    metricContext: "after their first auto-rewarded certification",
    quote: "Once an engineer earns one cert and sees the reward land, they go back for more. Self-driven upskilling used to be aspirational — now it&apos;s our default.",
    name: "Daniel Foster",
    title: "VP People Development",
  ...
  },
  {
    ...
    metric: "47",
    metricSuffix: "%",
    metricLabel: "skill-gap reduction",
    metricContext: "in critical roles after one year of L&D rewards",
    quote: "The skill multipliers were huge. We doubled rewards for cloud and AI — the team voted with their time. Cloud-skilled headcount tripled.",
    name: "Megan Hayes",
...
const STATS = [
  { value: "2×",   label: "Course completion lift" },
  { value: "94%",  label: "Continue learning" },
  { value: "47%",  label: "Skill-gap reduction" },
    ...
    <section className="relative bg-dark-300 py-20 lg:py-28 overflow-hidden">
      ...
      <div className="max-w-[1280px] mx-auto px-6">
        <div className="text-center max-w-xl mx-auto mb-14">
          ...
          <h2 className="text-3xl lg:text-4xl font-bold text-white tracking-tight mb-4">L&amp;D teams that turned learning into a flywheel</h2>
          <p className="text-dark-000 text-base leading-relaxed">Companies that swapped enrollment campaigns for completion-driven rewards — and saw self-driven upskilling explode.</p>
        </div>

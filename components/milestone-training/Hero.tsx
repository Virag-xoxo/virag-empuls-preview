...
const FLOATING_CHIPS = [
  { id: 1, emoji: "🏆", label: "Cert earned",         sub: "AWS Solutions Architect",   value: "+500", pos: "top-[6%] right-[2%]",     delay: "0s",   bg: "bg-white border-light-200", val: "text-blue-200" },
  { id: 2, emoji: "🔥", label: "30-day streak",        sub: "Sarah Mitchell · Internal", value: "+150", pos: "top-[58%] right-[-2%]",   delay: "0.6s", bg: "bg-white border-light-200", val: "text-orange-200" },
  { id: 3, emoji: "🎓", label: "Cohort graduated",     sub: "8 leaders · Degreed",       value: "+750", pos: "bottom-[10%] right-[6%]", delay: "1.1s", bg: "bg-white border-light-200", val: "text-green-300" },
];
      ...
      <div className="relative z-10 w-full max-w-[1280px] mx-auto px-6 pt-28 pb-12 grid lg:grid-cols-[1fr_500px] gap-16 items-center">
        <div className="flex flex-col items-start">
          ...
          <motion.h1 {...fadeUp(0.1)} className="text-[46px] lg:text-[60px] font-bold text-white leading-[1.06] tracking-tight mb-6">
            <span className="block">Every cert earned,</span>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-100 to-blue-200">every reward instant</span>
          </motion.h1>

          <motion.p {...fadeUp(0.2)} className="text-lg text-dark-000 max-w-md mb-10 leading-relaxed">
            Course completions, certifications, learning streaks — Empuls fires the reward the moment your LMS marks it done.
          </motion.p>
        ...
        <motion.div className="relative hidden lg:block h-[540px]"
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 bg-white/10 backdrop-blur-xl rounded-2xl border border-white/15 p-5 shadow-2xl">
            <div className="flex items-center justify-between mb-3">
              <span className="text-[9px] font-bold rounded-full px-2 py-0.5 bg-blue-200/15 border border-blue-100/20 text-blue-100">Coursera for Business</span>
              <span className="inline-flex items-center gap-1 text-[9px] font-bold text-green-200">
                <span className="w-1 h-1 rounded-full bg-green-200 animate-pulse" />JUST COMPLETED
              </span>
            </div>

            <p className="text-white text-[14px] font-extrabold leading-tight mb-1">AWS Solutions Architect</p>
            <p className="text-dark-000 text-[10px] mb-3">Associate · Passed with distinction · Score 94%</p>

            <div className="flex items-center gap-2.5 pb-3 mb-3 border-b border-white/10">
              <div className="w-8 h-8 rounded-full shrink-0 flex items-center justify-center text-white text-[11px] font-bold" style={{ background: "linear-gradient(135deg,#0a51e8,#2563eb)" }}>MH</div>
              <div className="min-w-0 flex-1">
                <p className="text-white text-[11px] font-semibold">Megan Hayes</p>
                <p className="text-dark-000 text-[9px]">Engineering · Cloud Infrastructure</p>
              </div>
            </div>

            <div className="flex items-center justify-between mb-3">
              <p className="text-white text-[11px] font-semibold">Reward fired automatically</p>
              <div className="text-right">
                <p className="text-blue-100 text-[12px] font-bold">⭐ 500 pts</p>
                <p className="text-green-200 text-[9px] font-semibold">✓ Sent to wallet</p>
              </div>
            </div>

            <div className="bg-white/5 border border-white/10 rounded-lg px-2.5 py-2">
              <p className="text-white text-[10px] font-bold mb-1">Slack notification sent</p>
              <p className="text-white/65 text-[10px] leading-snug">🏆 <span className="text-white font-semibold">Megan Hayes</span> just earned their <span className="text-white font-semibold">AWS Solutions Architect</span> certification!</p>
            </div>
          </div>

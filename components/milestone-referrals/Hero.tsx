...
const FLOATING_CHIPS = [
  { id: 1, emoji: "🎯", label: "Referral submitted",   sub: "+200 pts to referrer",     value: "Live", pos: "top-[6%] right-[2%]",     delay: "0s",   bg: "bg-white border-light-200", val: "text-blue-200" },
  { id: 2, emoji: "🎉", label: "Probation cleared",     sub: "+1,500 pts · final reward", value: "Done", pos: "top-[58%] right-[-2%]",   delay: "0.6s", bg: "bg-white border-light-200", val: "text-orange-200" },
  { id: 3, emoji: "🏆", label: "Top referrer · Wade G.", sub: "1,000 pts this quarter",   value: "#1",   pos: "bottom-[10%] right-[6%]", delay: "1.1s", bg: "bg-white border-light-200", val: "text-green-300" },
];
      ...
      <div className="relative z-10 w-full max-w-[1280px] mx-auto px-6 pt-28 pb-12 grid lg:grid-cols-[1fr_500px] gap-16 items-center">
        <div className="flex flex-col items-start">
          ...
          <motion.h1 {...fadeUp(0.1)} className="text-[46px] lg:text-[60px] font-bold text-white leading-[1.06] tracking-tight mb-6">
            <span className="block">Every great hire earns</span>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-100 to-blue-200">a team-wide win</span>
          </motion.h1>

          <motion.p {...fadeUp(0.2)} className="text-lg text-dark-000 max-w-md mb-10 leading-relaxed">
            Multi-stage referral rewards fire automatically as candidates move through your hiring pipeline.
          </motion.p>
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 bg-white/10 backdrop-blur-xl rounded-2xl border border-white/15 p-5 shadow-2xl">
            <div className="flex items-center gap-3 mb-4 pb-4 border-b border-white/10">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-white text-[12px] font-bold leading-tight">Referral Incentives</p>
                <p className="text-dark-000 text-[10px]">Track and reward every referral</p>
              </div>
              <span className="inline-flex items-center gap-1 bg-green-200/15 border border-green-200/20 rounded-full px-2 py-0.5 text-green-200 text-[9px] font-bold shrink-0">ACTIVE</span>
            </div>

            <div className="grid grid-cols-2 gap-2 mb-3">
              <div className="bg-white/5 border border-white/10 rounded-lg px-3 py-2">
                <p className="text-white text-lg font-extrabold leading-none tabular-nums">2</p>
                <p className="text-dark-000 text-[9px] mt-0.5">Total Referrals</p>
              </div>
              <div className="bg-white/5 border border-white/10 rounded-lg px-3 py-2">
                <p className="text-white text-lg font-extrabold leading-none tabular-nums">$2.5K</p>
                <p className="text-dark-000 text-[9px] mt-0.5">Total Earnings</p>
              </div>
            </div>
            ...
            <div className="space-y-1.5 mb-3">
              <div className="bg-white/5 border border-white/10 rounded-lg px-2.5 py-2">
                <div className="flex items-center justify-between mb-0.5">
                  <p className="text-white text-[11px] font-semibold truncate">John Nolan</p>
                  <span className="text-green-200 text-[9px] font-bold shrink-0">Completed ✓</span>
                </div>
                <div className="flex items-center justify-between">
                  <p className="text-dark-000 text-[9px]">Product Manager · Jul 15</p>
                  <span className="text-blue-100 text-[10px] font-bold">$1,250</span>
                </div>
              </div>
              <div className="bg-white/5 border border-white/10 rounded-lg px-2.5 py-2">
                <div className="flex items-center justify-between mb-0.5">
                  <p className="text-white text-[11px] font-semibold truncate">Bailey Nunn</p>
                  <span className="text-orange-200 text-[9px] font-bold shrink-0">90-Day Period</span>
                </div>
                <div className="flex items-center justify-between">
                  <p className="text-dark-000 text-[9px]">Software Engineer · Aug 15</p>
                  <span className="text-blue-100 text-[10px] font-bold">$1,250</span>
                </div>
              </div>
            </div>
            ...
            <div className="pt-3 border-t border-white/10 flex items-center justify-between">
              <span className="text-dark-000 text-[10px]">Auto-fires on every stage</span>
              <span className="text-blue-100 text-[10px] font-bold">Set up →</span>
            </div>
          </div>

    ...
    <section className="py-20 lg:py-28 bg-white overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-6">
        <motion.div className="text-center max-w-xl mx-auto mb-14"
          ...
          <h2 className="text-3xl lg:text-4xl font-bold text-dark-300 tracking-tight mb-4">Pulls from your ATS, posts wins where everyone sees them</h2>
          <p className="text-dark-100 text-base leading-relaxed">
            Native sync with Greenhouse, Lever, Workday Recruiting, SAP SuccessFactors, and others. HRIS keeps the new-hire data flowing. Celebration messages land in Slack, Teams, and email automatically.
          </p>
        </motion.div>
        ...
        <motion.div className="flex flex-wrap items-center justify-center gap-6 mt-10"
          ...
          <div className="flex flex-col items-center gap-2">
            <p className="text-[10px] font-bold uppercase tracking-[0.14em] text-dark-100">HRIS &amp; ATS</p>

...
const ATS_TOOLS = [
  { name: "Greenhouse",          short: "Gh",  bg: "#24a47f", type: "ATS" },
  { name: "Workday",             short: "W",   bg: "#f97316", type: "HRMS / ATS" },
  { name: "BambooHR",            short: "BH",  bg: "#73c41d", type: "HRMS" },
  { name: "SmartRecruiters",     short: "SR",  bg: "#1a2e56", type: "ATS" },
  { name: "SAP SuccessFactors",  short: "SAP", bg: "#0073e6", type: "HRMS" },
  { name: "Oracle HCM",          short: "Or",  bg: "#d32f2f", type: "HRMS" },
  { name: "Rippling",            short: "Ri",  bg: "#6254c0", type: "HRMS / ATS" },
    ...
    <section className="py-20 lg:py-28 bg-white overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-6">
        <motion.div className="text-center max-w-xl mx-auto mb-14"
          ...
          <h2 className="text-3xl lg:text-4xl font-bold text-dark-300 tracking-tight mb-4">Reads from your ATS. No manual updates.</h2>
          <p className="text-dark-100 text-base leading-relaxed">Empuls listens for status changes in your ATS and HRMS. The reward fires when the candidate moves — without anyone touching Empuls.</p>
        </motion.div>

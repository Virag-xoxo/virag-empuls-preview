...
const FEATURED = {
  ...
  metricContext: "across 8,500 employees, 14 countries",
  quote:
    "Birthdays and work anniversaries used to slip through the cracks. With Empuls Celebrations, every employee now feels remembered — and our HR team got 30 hours a month back.",
  name: "Jennifer Walsh",
...
const COMPACT = [
  {
    ...
    quote:
      "Wishboards landed perfectly in our Slack-first culture. Teammates add a wish in 30 seconds — and the employee opens a board full of love on their day.",
    name: "Marcus Johnson",
  ...
  },
  {
    ...
    metricContext: "after 6 months of automated celebrations",
    quote:
      "The HRMS sync was effortless — every new hire's birthday and anniversaries are scheduled the day they join. Nobody is forgotten anymore.",
...
const STATS = [
  { value: "247", label: "Milestones celebrated / quarter" },
  { value: "4.8", label: "Avg. employee satisfaction (★)" },
  { value: "50+", label: "HRMS integrations" },
  { value: "10M+", label: "Gift catalog options" },
];
      ...
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        <div className="text-center max-w-xl mx-auto mb-14">
          ...
          <h2 className="text-3xl lg:text-4xl font-bold text-white tracking-tight mb-4">
            Trusted by teams that care about people
          </h2>
          <p className="text-dark-000 text-base leading-relaxed">
            See how companies around the world use Empuls to make every milestone count — without HR lifting a finger.
          </p>
        </div>

    ...
    <section className="py-20 lg:py-28 bg-white overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-6">
        <motion.div className="text-center max-w-xl mx-auto mb-14"
          ...
          <p className="text-[11px] font-bold uppercase tracking-[0.15em] text-blue-200 mb-3">Lives in the daily feed</p>
          <h2 className="text-3xl lg:text-4xl font-bold text-dark-300 tracking-tight mb-4">HRIS-segmented. Channel-delivered.</h2>
          <p className="text-dark-100 text-base leading-relaxed">
            The check-in widget lives directly in the Empuls feed. Org segmentation pulls from Workday, BambooHR, SAP, Oracle, and Rippling so the heatmap is always slicing the current org chart. Heatmap shifts and alerts notify HR in Slack and Teams.
          </p>
        </motion.div>

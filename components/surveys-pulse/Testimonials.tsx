...
const COMPACT = [
  {
    ...
    metricContext: "earlier detection of disengagement signals when pulse surveys run monthly vs annual surveys alone",
    quote: "The driver heatmap caught a manager-relationship dip in one of our pods three weeks before the team lead would have flagged it. We intervened, and the score recovered the next cycle.",
    name: "Daniel Foster",
...
const STATS = [
  { value: "3×",   label: "Earlier warning" },
  { value: "94%",  label: "Completion rate" },
  { value: "9",    label: "Drivers tracked" },
      ...
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        <motion.figure className="bg-white/8 border border-white/12 rounded-2xl p-7 lg:p-8 mb-4 grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-6 lg:gap-12 items-center"
          ...
          <div>
            ...
            <p className="text-dark-100 text-xs mb-5" dangerouslySetInnerHTML={{ __html: FEATURED.metricContext }} />

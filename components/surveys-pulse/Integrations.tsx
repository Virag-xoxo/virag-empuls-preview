    ...
    <section className="py-20 lg:py-28 bg-white overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-6">
        <motion.div className="text-center max-w-xl mx-auto mb-14"
          ...
          <p className="text-[11px] font-bold uppercase tracking-[0.15em] text-blue-200 mb-3">Where pulse surveys live</p>
          <h2 className="text-3xl lg:text-4xl font-bold text-dark-300 tracking-tight mb-4">Delivered in Slack and Teams. Synced from your HRIS.</h2>
          <p className="text-dark-100 text-base leading-relaxed">
            Surveys delivered through channels employees already use. HRIS sync from Workday, BambooHR, SAP SuccessFactors, Oracle HCM, and Rippling auto-segments responses by team, tenure, location, or grade &mdash; without manual list management.
          </p>
        </motion.div>

        <motion.div initial={reduce ? false : { opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: reduce ? 0 : 0.6, ease, delay: 0.1 }}

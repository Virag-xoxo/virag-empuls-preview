      ...
      <div className="max-w-[1280px] mx-auto px-6">
        <motion.div className="text-center max-w-xl mx-auto mb-14"
          ...
          <p className="text-dark-100 text-base leading-relaxed">
            Surveys delivered through channels employees already use. HRIS sync from Workday, BambooHR, SAP SuccessFactors, Oracle HCM, and Rippling auto-segments responses by team, tenure, location, or grade — without manual list management.
          </p>
        </motion.div>

        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-10 lg:gap-16">
          <motion.div className="max-w-xl"
            ...
            <h2 className="text-4xl lg:text-5xl font-bold tracking-tight leading-tight mb-6">
              <span className="text-white">Every project deserves<br/></span>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-100 to-blue-200">a proper send-off</span>
            </h2>
            <p className="text-dark-000 text-base leading-relaxed">
              See how Empuls automatically rewards project teams the moment delivery happens — in a 20-minute walkthrough.
            </p>
          </motion.div>

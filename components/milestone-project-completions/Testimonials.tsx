...
const FEATURED = {
  ...
  metric: "67",
  metricSuffix: "%",
  metricLabel: "more on-time deliveries",
  metricContext: "across product teams running auto-rewards",
  quote: "Our project teams used to ship and move on. Now every release ends with a real moment — a reward in #engineering, reactions, the whole team feeling seen. On-time delivery is up 67%.",
  name: "Catherine Reed",
...
const COMPACT = [
  ...
  },
  {
    ...
    metric: "31",
    metricSuffix: "%",
    metricLabel: "more discretionary effort",
    metricContext: "from contributors recognized within 24 hours of ship",
    quote: "Phased rewards changed how we run long projects. Engineers see real recognition at every stage gate, not just at the finish line.",
    name: "Megan Hayes",
...
const STATS = [
  { value: "1M+",  label: "Reward catalog" },
  { value: "175+", label: "Countries" },
  { value: "8",    label: "Project tools natively" },
  { value: "0",    label: "Manual splits" },
];
    ...
    <section className="relative bg-dark-300 py-20 lg:py-28 overflow-hidden">
      ...
      <div className="max-w-[1280px] mx-auto px-6">
        <div className="text-center max-w-xl mx-auto mb-14">
          ...
          <h2 className="text-3xl lg:text-4xl font-bold text-white tracking-tight mb-4">Trusted by teams that ship — and celebrate</h2>
          <p className="text-dark-000 text-base leading-relaxed">Companies that turned ship-and-move-on into ship-and-celebrate. Without the manual overhead.</p>
        </div>

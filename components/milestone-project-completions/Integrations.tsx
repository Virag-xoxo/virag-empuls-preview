    ...
    <section className="py-20 lg:py-28 bg-white overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-6">
        <motion.div className="text-center max-w-xl mx-auto mb-14"
          ...
          <h2 className="text-3xl lg:text-4xl font-bold text-dark-300 tracking-tight mb-4">Reads from your project stack, posts wins where everyone sees them</h2>
          <p className="text-dark-100 text-base leading-relaxed">
            Native webhooks for Jira, Linear, Asana, Monday, GitHub, and MS Project. HRIS sync keeps the recipient list current. Celebrations land in Slack, Teams, and email automatically.
          </p>
        </motion.div>

...
const FLOATING_CHIPS = [
  { id: 1, emoji: "🚀", label: "Sprint closed",       sub: "Catalyst v2.0 · Eng",       value: "Live", pos: "top-[6%] right-[2%]",     delay: "0s",   bg: "bg-white border-light-200", val: "text-blue-200" },
  { id: 2, emoji: "📊", label: "8 contributors paid", sub: "1,000 pts each",            value: "Sent", pos: "top-[58%] right-[-2%]",   delay: "0.6s", bg: "bg-white border-light-200", val: "text-orange-200" },
  { id: 3, emoji: "⚡", label: "Auto-fired in 0.3s",   sub: "Manager → Slack",           value: "Fast", pos: "bottom-[10%] right-[6%]", delay: "1.1s", bg: "bg-white border-light-200", val: "text-green-300" },
];
      ...
      <div className="relative z-10 w-full max-w-[1280px] mx-auto px-6 pt-28 pb-12 grid lg:grid-cols-[1fr_500px] gap-16 items-center">
        <div className="flex flex-col items-start">
          ...
          <motion.h1 {...fadeUp(0.1)} className="text-[46px] lg:text-[60px] font-bold text-white leading-[1.06] tracking-tight mb-6">
            <span className="block">Reward the team</span>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-100 to-blue-200">the moment work ships</span>
          </motion.h1>
        ...
        <motion.div className="relative hidden lg:block h-[540px]"
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 bg-white/10 backdrop-blur-xl rounded-2xl border border-white/15 p-5 shadow-2xl">
            <div className="flex items-start gap-3 mb-4 pb-4 border-b border-white/10">
              <div className="w-9 h-9 rounded-lg bg-blue-200/15 border border-blue-100/20 flex items-center justify-center text-base shrink-0">🎯</div>
              <div className="min-w-0 flex-1">
                <p className="text-white text-[12px] font-bold leading-tight">Project Completion</p>
                <p className="text-dark-000 text-[10px] mt-0.5">Auto-trigger fired</p>
              </div>
              <span className="inline-flex items-center gap-1 bg-green-200/15 border border-green-200/20 rounded-full px-2 py-0.5 text-green-200 text-[9px] font-bold shrink-0">
                <span className="w-1 h-1 rounded-full bg-green-200" />DONE
              </span>
            </div>

            <p className="text-white text-[13px] font-extrabold mb-1">Catalyst App v2.0</p>
            <p className="text-dark-000 text-[10px] mb-3">Engineering · Shipped 2 days early</p>

            <div className="flex flex-wrap gap-1.5 mb-3">
              <span className="text-[9px] font-semibold text-blue-100 bg-blue-200/15 border border-blue-100/20 rounded-full px-2 py-0.5">Q1 Launch</span>
              <span className="text-[9px] font-semibold text-blue-100 bg-blue-200/15 border border-blue-100/20 rounded-full px-2 py-0.5">P0</span>
              <span className="text-[9px] font-semibold text-blue-100 bg-blue-200/15 border border-blue-100/20 rounded-full px-2 py-0.5">8-week sprint</span>
            </div>

            <div className="flex items-center gap-2 mb-3 pb-3 border-b border-white/10">
              <div className="flex -space-x-1.5">
                {[
                  { i: "SM", g: "linear-gradient(135deg,#0a51e8,#2563eb)" },
                  { i: "DT", g: "linear-gradient(135deg,#7c3aed,#a855f7)" },
                  { i: "AM", g: "linear-gradient(135deg,#059669,#10b981)" },
                  { i: "MH", g: "linear-gradient(135deg,#e11d48,#f43f5e)" },
                ].map((a) => (
                  <div key={a.i} className="w-6 h-6 rounded-full ring-2 ring-dark-300 flex items-center justify-center text-[8px] font-bold text-white" style={{ background: a.g }}>{a.i}</div>
                ))}
                <div className="w-6 h-6 rounded-full ring-2 ring-dark-300 bg-white/15 flex items-center justify-center text-[8px] font-bold text-white">+4</div>
              </div>
              <div className="ml-1">
                <p className="text-white text-[10px] font-semibold">8 team members</p>
                <p className="text-dark-000 text-[9px]">All eligible</p>
              </div>
            </div>

            <div className="flex items-center gap-2.5 bg-blue-200/10 border border-blue-100/20 rounded-lg p-2.5">
              <span className="text-base">⭐</span>
              <div className="flex-1 min-w-0">
                <p className="text-white text-[11px] font-bold">Reward distributed</p>
                <p className="text-blue-100 text-[10px] font-semibold">1,000 pts × 8 = 8,000 pts</p>
                <p className="text-dark-000 text-[9px]">via Slack · just now</p>
              </div>

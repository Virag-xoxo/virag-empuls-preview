...
const FEATURED = {
  ...
  metric: "3",
  metricSuffix: "×",
  metricLabel: "quota attainment",
  metricContext: "across our AE pods after structured tier programs replaced flat commissions",
  quote: "Reps stopped spending the last week of the quarter scrolling spreadsheets. They closed deals. The plan was visible, the payout was instant, and effort actually compounded the way the comp structure said it would.",
  name: "Daniel Foster",
...
const STATS = [
  { value: "3×",   label: "Quota attainment lift" },
  { value: "22%",  label: "Revenue increase" },
  { value: "89%",  label: "Rep satisfaction" },

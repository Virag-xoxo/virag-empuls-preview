    ...
    <section className="py-20 lg:py-28 bg-white overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-6">
        <motion.div className="text-center max-w-xl mx-auto mb-14"
          ...
          <p className="text-[11px] font-bold uppercase tracking-[0.15em] text-blue-200 mb-3">Connects to your sales stack</p>
          ...
          <p className="text-dark-100 text-base leading-relaxed">
            Native CRM connectors for Salesforce, HubSpot, Zoho, Pipedrive, and Microsoft Dynamics. HRIS sync for the recipient roster, payroll, and roles. Reward notifications land in Slack, Teams, and email automatically.
          </p>
        </motion.div>

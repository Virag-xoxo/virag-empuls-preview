    ...
    <section className="py-20 lg:py-28 bg-white overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-6">
        <motion.div className="text-center max-w-xl mx-auto mb-14"
          ...
          <p className="text-[11px] font-bold uppercase tracking-[0.15em] text-blue-200 mb-3">Connects everywhere your team works</p>
          <h2 className="text-3xl lg:text-4xl font-bold text-dark-300 tracking-tight mb-4">HRMS-driven enrollment for distributed workforces</h2>
          <p className="text-dark-100 text-base leading-relaxed">
            Native sync with Workday, BambooHR, SAP SuccessFactors, Darwinbox, Rippling, ADP, and UKG. New hires auto-enroll on day one, departures auto-removed, recipient roster always reflects the current org chart.
          </p>
        </motion.div>

...
export default function FinalCTA() {
  ...
  return (
    <section className="relative bg-dark-300 overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 w-[480px] h-[480px] pointer-events-none" style={{ background: "radial-gradient(ellipse at 80% 80%, rgba(206,222,255,0.5) 0%, rgba(99,102,241,0.10) 40%, transparent 70%)" }} />
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-10 lg:gap-16">
          <motion.div className="max-w-xl"
            ...
            <h2 className="text-4xl lg:text-5xl font-bold tracking-tight leading-tight mb-6">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-100 to-blue-200">made for them</span>
            </h2>
          ...
          <motion.div className="flex flex-col gap-4 lg:items-end lg:shrink-0"
            ...
            <div className="flex items-center gap-5">
              ...
              <a href="#" className="inline-flex items-center gap-1.5 text-white text-sm font-semibold hover:text-blue-200 transition-colors">
                Talk to sales

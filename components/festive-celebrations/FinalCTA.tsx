...
export default function FinalCTA() {
  ...
  return (
    <section className="relative bg-dark-300 overflow-hidden">
      ...
      <div className="blob-1 absolute -top-40 left-1/4 w-[550px] h-[550px] rounded-full pointer-events-none" style={{ background: "radial-gradient(circle, rgba(245,180,90,0.26) 0%, transparent 65%)" }} />
      ...
      <div className="absolute bottom-0 right-0 w-[480px] h-[480px] pointer-events-none" style={{ background: "radial-gradient(ellipse at 80% 80%, rgba(245,180,90,0.18) 0%, rgba(220,38,38,0.08) 40%, transparent 70%)" }} />
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-10 lg:gap-16">
          <motion.div className="max-w-xl"
            ...
            <h2 className="text-4xl lg:text-5xl font-bold tracking-tight leading-tight mb-6">
              <span className="text-white">Make every festival<br/></span>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-200 to-blue-100">made for them</span>
            </h2>
            <p className="text-dark-000 text-base leading-relaxed">
              See how Empuls manages festive gifting across cultures and countries — in a 20-minute walkthrough.
            </p>
          </motion.div>

          <motion.div className="flex flex-col gap-4 lg:items-end lg:shrink-0"
            initial={reduce ? undefined : { opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.4 }} transition={{ duration: 0.55, ease: [0,0,0.2,1] as const, delay: 0.1 }}>
            <div className="flex items-center gap-5">
              ...
              <a href="#" className="inline-flex items-center gap-1.5 text-white text-sm font-semibold hover:text-orange-200 transition-colors">
                Talk to sales

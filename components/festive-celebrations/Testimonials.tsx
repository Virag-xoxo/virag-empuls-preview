...
const FEATURED = {
  ...
  metric: "12",
  metricSuffix: "",
  metricLabel: "festivals automated annually",
  metricContext: "across 38 countries — zero manual sends",
  quote: "Diwali, Christmas, Lunar New Year, Eid — all going out automatically every year, regionally targeted. Our HR team finally stopped scrambling on holidays.",
  name: "Catherine Reed",
  title: "Director of Global People Programs",
...
const COMPACT = [
  {
    ...
    metric: "72",
    metricSuffix: "%",
    metricLabel: "feel culturally seen",
    metricContext: "in employee surveys after rollout",
    quote: "Festive gifting was the missing piece. Now our team in Mumbai feels just as celebrated as our team in San Francisco.",
    name: "Megan Hayes",
    title: "Head of Belonging",
  ...
  },
  {
    ...
    metric: "0",
    metricSuffix: "",
    metricLabel: "manual festival sends",
    metricContext: "since switching to automated annual cadence",
    quote: "We picked Empuls because of audience targeting — different gifts per region, all from one campaign. It scales to 75K with one HR person.",
    name: "Daniel Foster",
...
const STATS = [
  { value: "50+",   label: "Festivals pre-loaded" },

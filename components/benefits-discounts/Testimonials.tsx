...
const FEATURED = {
  ...
  metric: "$7,000",
  metricSuffix: "+",
  metricLabel: "avg household savings",
  metricContext: "annual household savings on a $90,000 income — equivalent to a 7.8% raise at zero cost to the company",
  quote: "We turned the Perks Store on, sent one announcement email, and watched 78% of the workforce activate it in a week. Free for us, thousands saved per employee.",
  name: "Catherine Reed",
...
const COMPACT = [
  {
    ...
    metricContext: "of eligible employees actively using the Perks Store every month — well above benefits-portal benchmarks",
    quote: "What surprised us is the breadth — gift cards, travel, even the cashback wallet. People treat it like a perk they earned, not a benefit they were assigned.",
    name: "Daniel Foster",
  ...
  },
  {
    ...
    metric: "2.4",
    metricSuffix: "×",
    metricLabel: "monthly sessions per user",
    metricContext: "average return visits per active user — proof that the catalog stays fresh enough to bring people back",
    quote: "It became part of how people shop. New brand drops, time-limited deals, daily cashback — the store earns repeat traffic without us pushing it.",
    name: "Megan Hayes",
...
const STATS = [
  { value: "$7,000+", label: "Avg household savings" },
  { value: "78%",     label: "Active monthly users" },
  { value: "2.4×",    label: "Sessions per user" },
    ...
    <section className="relative bg-dark-300 py-20 lg:py-28 overflow-hidden">
      ...
      <div className="max-w-[1280px] mx-auto px-6">
        <div className="text-center max-w-xl mx-auto mb-14">
          ...
          <h2 className="text-3xl lg:text-4xl font-bold text-white tracking-tight mb-4">A perks store people actually open every day</h2>
          <p className="text-dark-000 text-base leading-relaxed">Companies that turned on the Perks Store and watched adoption, savings, and repeat visits compound — without a single dollar of company spend.</p>
        </div>

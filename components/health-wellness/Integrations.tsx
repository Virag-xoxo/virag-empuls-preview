    ...
    <section className="py-20 lg:py-28 bg-white overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-6">
        <motion.div className="text-center max-w-xl mx-auto mb-14"
          ...
          <h2 className="text-3xl lg:text-4xl font-bold text-dark-300 tracking-tight mb-4">Connects to your HRMS, channels, and partner network</h2>
          <p className="text-dark-100 text-base leading-relaxed">
            Wellness partners covering checkups, pharmacy, mental health, and home care &mdash; alongside HRMS sync (Workday, BambooHR, SAP, Darwinbox, Rippling) and channel notifications in Slack and Teams.
          </p>
        </motion.div>

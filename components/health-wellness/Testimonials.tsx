...
const FEATURED = {
  ...
  metric: "84",
  metricSuffix: "%",
  metricLabel: "wellness store activation",
  metricContext: "of eligible employees activated their wellness wallet within 60 days of program launch",
  quote: "We used to run wellness as a once-a-year benefit announcement. Now it lives in the same wallet as recognition — and the numbers show people actually use it every month.",
  name: "Catherine Reed",
...
const COMPACT = [
  {
    ...
    metricContext: "average distinct wellness categories employees used in their first program year — fitness, checkups, mental health, more",
    quote: "What changed was breadth. Same allowance covered yoga, therapy, and a kids' pediatric visit. Wellness stopped meaning just gym memberships.",
    name: "Daniel Foster",
  ...
  },
  {
    ...
    metricContext: "average employee satisfaction score on the wellness program after the first full plan year",
    quote: "When the wellness wallet is the same wallet as gift cards and rewards, people just open it. Adoption isn't a campaign — it's already there.",
    name: "Megan Hayes",
...
const STATS = [
  { value: "84%",  label: "Wellness activation" },
  { value: "5",    label: "Categories per user" },
    ...
    <section className="relative bg-dark-300 py-20 lg:py-28 overflow-hidden">
      ...
      <div className="max-w-[1280px] mx-auto px-6">
        <div className="text-center max-w-xl mx-auto mb-14">
          ...
          <h2 className="text-3xl lg:text-4xl font-bold text-white tracking-tight mb-4">People teams that turned wellness into a daily habit</h2>
          <p className="text-dark-000 text-base leading-relaxed">Companies that swapped one-off wellness campaigns for an always-on wallet &mdash; and watched activation, breadth, and satisfaction climb together.</p>
        </div>

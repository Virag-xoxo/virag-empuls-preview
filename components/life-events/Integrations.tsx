    ...
    <section className="py-20 lg:py-28 bg-white overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-6">
        <motion.div className="text-center max-w-xl mx-auto mb-14"
          ...
          <h2 className="text-3xl lg:text-4xl font-bold text-dark-300 tracking-tight mb-4">Life event gifts in the tools your teams use</h2>
          <p className="text-dark-100 text-base leading-relaxed">HRMS-connected for global rollout. Slack, Teams, email — the gift arrives where the recipient works.</p>
        </motion.div>

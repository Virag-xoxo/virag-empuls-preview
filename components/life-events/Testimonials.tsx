...
const FEATURED = {
  ...
  metric: "94",
  metricSuffix: "%",
  metricLabel: "of life event gifts opened",
  metricContext: "across 38 countries within 24 hours",
  quote: "Our HR team used to send life event gifts manually with spreadsheets and shipping addresses. Now it’s 30 seconds per send — the recipient picks what they want, anywhere in the world.",
  name: "Catherine Reed",
...
const COMPACT = [
  {
    ...
    metric: "0",
    metricSuffix: "",
    metricLabel: "missed milestones",
    metricContext: "since rolling out automated life-event gifting",
    quote: "From a wedding in Madrid to a new baby in Toronto — every employee gets the same caring moment.",
    name: "Daniel Foster",
  ...
  },
  {
    ...
    metric: "10×",
    metricSuffix: "",
    metricLabel: "faster gift sending",
    metricContext: "vs. our previous procurement-driven flow",
    quote: "The recipient picks what they want from a curated collection. The thoughtfulness scales with our headcount.",
    name: "Megan Hayes",
...
const STATS = [
  { value: "10M+", label: "Reward options globally" },
  { value: "175+", label: "Countries supported" },
  { value: "30s",  label: "To send a gift" },
  { value: "100%", label: "Recipient choice" },
];
    ...
    <section className="relative bg-dark-300 py-20 lg:py-28 overflow-hidden">
      ...
      <div className="max-w-[1280px] mx-auto px-6">
        <div className="text-center max-w-xl mx-auto mb-14">
          ...
          <h2 className="text-3xl lg:text-4xl font-bold text-white tracking-tight mb-4">Trusted by teams that see the whole person</h2>
          <p className="text-dark-000 text-base leading-relaxed">Companies that turned life-event gifting from a manual chore into a moment that scales.</p>
        </div>

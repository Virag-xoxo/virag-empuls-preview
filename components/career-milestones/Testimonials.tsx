...
const FEATURED = {
  ...
  metricContext: "after rolling out automated milestone recognition",
  quote: "Promotions used to slip through the cracks for our remote teams. Now every title change shows up on the company feed within minutes — and the recognition feels real, not procedural.",
  name: "Catherine Reed",
...
const COMPACT = [
  {
    ...
    metricContext: "across 14 countries, all from HRMS triggers",
    quote: "We didn't realise how many promotions and certifications were going unannounced. Now they all surface — automatically.",
    name: "Megan Hayes",
  ...
  },
  {
    ...
    metric: "3×",
    metricSuffix: "",
    metricLabel: "more peer recognition",
    metricContext: "per milestone post compared to email announcements",
    quote: "The public feed plus comments turns a single promotion into a moment the whole org talks about. Manager nudges and reactions do the rest.",
    name: "Daniel Foster",
...
const STATS = [
  { value: "6+",   label: "Milestone types supported" },
  { value: "10M+", label: "Reward options" },
    ...
    <section className="relative bg-dark-300 py-20 lg:py-28 overflow-hidden">
      ...
      <div className="max-w-[1280px] mx-auto px-6">
        <div className="text-center max-w-xl mx-auto mb-14">
          ...
          <h2 className="text-3xl lg:text-4xl font-bold text-white tracking-tight mb-4">Trusted by teams that take growth seriously</h2>
          <p className="text-dark-000 text-base leading-relaxed">Companies that turned promotion announcements from email afterthoughts into company-wide moments.</p>
        </div>
        ...
        <motion.figure className="bg-white/8 border border-white/12 rounded-2xl p-7 lg:p-8 mb-4 grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-6 lg:gap-12 items-center"
          ...
          <figcaption className="flex items-center gap-3 lg:flex-col lg:items-start lg:gap-4 shrink-0 lg:min-w-[200px] border-t border-white/10 pt-5 lg:border-t-0 lg:pt-0 lg:border-l lg:border-white/10 lg:pl-12">
            ...
            <div>
              ...
              <p className="text-dark-100 text-xs mt-0.5" dangerouslySetInnerHTML={{ __html: FEATURED.title }} />

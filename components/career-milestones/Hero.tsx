...
const FLOATING_CHIPS = [
  { id: 1, emoji: "🚀", label: "Promotion announced",  sub: "Daniel F. → Senior PM",     value: "Live",  pos: "top-[6%] right-[2%]",     delay: "0s",   bg: "bg-white border-light-200", val: "text-blue-200" },
  { id: 2, emoji: "📜", label: "AWS Certification",    sub: "Megan H. earned today",     value: "Done",  pos: "top-[58%] right-[-2%]",   delay: "0.6s", bg: "bg-white border-light-200", val: "text-orange-200" },
  { id: 3, emoji: "🏆", label: "Project shipped",      sub: "Q3 Roadmap · 8 contributors", value: "Buzz", pos: "bottom-[10%] right-[6%]", delay: "1.1s", bg: "bg-white border-light-200", val: "text-green-300" },
];
      ...
      <div className="relative z-10 w-full max-w-[1280px] mx-auto px-6 pt-28 pb-12 grid lg:grid-cols-[1fr_500px] gap-16 items-center">
        <div className="flex flex-col items-start">
          ...
          <motion.h1 {...fadeUp(0.1)} className="text-[46px] lg:text-[60px] font-bold text-white leading-[1.06] tracking-tight mb-6">
            <span className="block">Every promotion gets</span>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-100 to-blue-200">company-wide cheers</span>
          </motion.h1>
        ...
        <motion.div className="relative hidden lg:block h-[540px]"
          ...
          {/* Promotion announcement card (Empuls feed mock) */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 bg-white/10 backdrop-blur-xl rounded-2xl border border-white/15 p-5 shadow-2xl">
            <div className="inline-flex items-center gap-1.5 bg-blue-200/15 border border-blue-100/20 rounded-full px-2.5 py-1 mb-3">
              ...
              <span className="text-blue-100 text-[10px] font-semibold uppercase tracking-wide">✦ Empuls feed · Live</span>
            </div>

            <div className="flex items-start gap-3 mb-4 pb-4 border-b border-white/10">
              <div className="w-9 h-9 rounded-full shrink-0 flex items-center justify-center text-white text-xs font-bold bg-blue-200">DF</div>
              <div className="min-w-0 flex-1">
                <p className="text-white text-[12px] font-bold leading-snug">Daniel Foster promoted to Senior Product Manager</p>
                <p className="text-dark-000 text-[10px] mt-0.5">Empuls Celebrations · Just now</p>
              </div>
            </div>

            <p className="text-white/80 text-[11px] leading-relaxed mb-3">
              We&apos;re thrilled to celebrate <span className="text-white font-semibold">Daniel&apos;s</span> promotion to <span className="text-white font-semibold">Senior PM</span>! His leadership on the Q3 roadmap made this an easy call. 🚀
            </p>

            <div className="flex items-center gap-2.5 bg-white/5 border border-white/10 rounded-lg px-3 py-2 mb-3">
              <span className="text-lg">🏅</span>
              <div className="flex-1 min-w-0">
                <p className="text-white text-[11px] font-bold">Career Milestone Certificate</p>
                <p className="text-dark-000 text-[9px]">Senior PM · 2026 · Salesforce</p>
              </div>
              <span className="text-blue-100 text-[10px] font-bold">↓</span>
            </div>

            <div className="flex items-center gap-1.5 mb-3">
              <span className="bg-white/8 text-white/85 text-[10px] rounded px-2 py-0.5 font-semibold">👏 52</span>
              <span className="bg-white/8 text-white/85 text-[10px] rounded px-2 py-0.5 font-semibold">❤️ 41</span>
              <span className="bg-white/8 text-white/85 text-[10px] rounded px-2 py-0.5 font-semibold">🚀 28</span>
              <span className="bg-white/8 text-white/85 text-[10px] rounded px-2 py-0.5 font-semibold ml-auto">💬 15</span>
            </div>

            <div className="bg-white/5 border border-white/10 rounded-lg px-2.5 py-2 flex items-start gap-2">
              <div className="w-5 h-5 rounded-full bg-blue-200 shrink-0 flex items-center justify-center text-[8px] font-bold text-white">RK</div>
              <p className="text-white/75 text-[10px] leading-snug">&ldquo;This is SO deserved. Daniel has been carrying that roadmap 🙌&rdquo;</p>
            </div>
          </div>
